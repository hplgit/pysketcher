...
class Gravity(Force):
    ...
    def __init__(self, start, length, text_position: ArrowWithText.TextPosition = ArrowWithText.TextPosition.START, text="$g$"):
        Force.__init__(self, text, start, start + Point(0, -length), text_position=text_position)
