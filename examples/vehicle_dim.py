from pysketcher import MatplotlibDraw, Circle, Rectangle, Point, Wall, Composition, Style, ArrowWithText, DistanceWithText
...
H2_dim = DistanceWithText('$\\frac{5}{4}H$', Point(hdp, 2*R + H), Point(hdp, 2*R + (9 / 4) * H))
