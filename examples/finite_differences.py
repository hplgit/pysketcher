...
centered_lines = ps.Composition({"left": vlineb, "right": vlinef})
centered_lines2 = ps.Composition({"left": vlineb, "right": vlinef, "center": vlinec})
...
backward = ps.Composition(
    dict(
        ...
        point2=cb,
        coor=backward_lines,
        name=ps.Text("backward", backward_tangent.end + ps.Point(0.1, 0)).set_alignment(
            ps.TextStyle.Alignment.LEFT
        ),
    )
)
centered = ps.Composition(
    dict(
        ...
        name=ps.Text("centered", centered_tangent.end + ps.Point(0.1, 0)).set_alignment(
            ps.TextStyle.Alignment.LEFT
        ),
    )
)
